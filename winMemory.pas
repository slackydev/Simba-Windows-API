...
function LibKernel32.VirtualAlloc(Address: Pointer; Size: SizeInt; flAllocationType, flProtect: DWORD): Pointer; static; external 'VirtualAlloc@Kernel32.dll' + WINAPI_CC;
...
function LibKernel32.VirtualAllocEx(hProc: HANDLE; Address: Pointer; Size: SizeInt; flAllocationType, flProtect: DWORD): Pointer; static; external 'VirtualAllocEx@Kernel32.dll' + WINAPI_CC;
...
function LibKernel32.VirtualAllocExNuma(hProc: HANDLE; Address: Pointer; Size: SizeInt; flAllocationType, flProtect, nndPreferred: DWORD): Pointer; static; external 'VirtualAllocExNuma@Kernel32.dll' + WINAPI_CC;

// BOOL WINAPI VirtualFree(_In_ LPVOID lpAddress,_In_ SIZE_T dwSize,_In_ DWORD dwFreeType);
function LibKernel32.VirtualFree(Address: Pointer; Size: SizeInt; dwFreeType: DWORD): WINBOOL; static; external 'VirtualFree@Kernel32.dll' + WINAPI_CC;

// BOOL WINAPI VirtualFreeEx(_In_ HANDLE hProcess,_In_ LPVOID lpAddress,_In_ SIZE_T dwSize,_In_ DWORD dwFreeType);
function LibKernel32.VirtualFreeEx(hProc: HANDLE; Address: Pointer; Size: SizeInt; dwFreeType: DWORD): WINBOOL; static; external 'VirtualFreeEx@Kernel32.dll' + WINAPI_CC;

// BOOL WINAPI VirtualLock(_In_ LPVOID lpAddress,_In_ SIZE_T dwSize);
function LibKernel32.VirtualLock(Address: Pointer; Size: SizeInt): WINBOOL; static; external 'VirtualLock@Kernel32.dll' + WINAPI_CC;

// BOOL WINAPI VirtualProtect(_In_ LPVOID lpAddress, _In_  SIZE_T dwSize, _In_  DWORD  flNewProtect, _Out_ PDWORD lpflOldProtect);
function LibKernel32.VirtualProtect(Address: Pointer; Size: SizeInt; flNewProtect: DWORD; out flOldProtect: DWORD): WINBOOL; static; external 'VirtualProtect@Kernel32.dll' + WINAPI_CC;
...
function LibKernel32.VirtualProtectEx(hProc: HANDLE; Address: Pointer; Size: SizeInt; flNewProtect: DWORD; out flOldProtect: DWORD): WINBOOL; static; external 'VirtualProtectEx@Kernel32.dll' + WINAPI_CC;

// SIZE_T WINAPI VirtualQuery(_In_opt_ LPCVOID lpAddress, _Out_ PMEMORY_BASIC_INFORMATION lpBuffer, _In_ SIZE_T dwLength);
function LibKernel32.VirtualQuery(Address: Pointer; out buffer: MEMORY_BASIC_INFORMATION; dwLength: SizeInt): SizeInt; static; external 'VirtualQuery@Kernel32.dll' + WINAPI_CC;
...
function LibKernel32.VirtualQueryEx(hProc: HANDLE; Address: Pointer; out buffer: MEMORY_BASIC_INFORMATION; dwLength: SizeInt): SizeInt; static; external 'VirtualQueryEx@Kernel32.dll' + WINAPI_CC;

// BOOL WINAPI VirtualUnlock(_In_ LPVOID lpAddress, _In_ SIZE_T dwSize);
function LibKernel32.VirtualUnlock(Address: Pointer; dwSize: SizeInt): WINBOOL; static; external 'VirtualUnlock@Kernel32.dll' + WINAPI_CC;
...
function LibKernel32.ReadProcessMemory(hProc: HANDLE; baseAddr: Pointer; buffer: Pointer; nSize: SizeInt; out numBytesRead: SizeInt): WINBOOL; static; external 'ReadProcessMemory@Kernel32.dll' + WINAPI_CC;
...
function LibKernel32.WriteProcessMemory(hProc: HANDLE; baseAddr: Pointer; buffer: Pointer; nSize: SizeInt; out numBytesWritten: SizeInt): WINBOOL; static; external 'WriteProcessMemory@Kernel32.dll' + WINAPI_CC;
