...
function LibGdi32.GetObject(hObject: HGDIOBJ; cbBuffer: Int32; lpvObject: Pointer): Int32; static; external 'GetObjectW@gdi32.dll stdcall';
function LibGdi32.CreateCompatibleDC(dc: HDC): HDC; static; external 'CreateCompatibleDC@gdi32.dll stdcall';
function LibGdi32.SelectObject(dc:HDC; hObject: HGDIOBJ): HGDIOBJ; static; external 'SelectObject@gdi32.dll stdcall';


function LibUser32.GetDC(wnd: HWND): HDC; static; external 'GetDC@user32.dll stdcall';
function LibUser32.GetWindowDC(wnd: HWND): HDC; static; external 'GetWindowDC@user32.dll stdcall';
function LibUser32.GetDCEx(wnd: HWND; hrgnClip:HRGN; flags:DWord): HDC; static; external 'GetDCEx@user32.dll stdcall';
function LibUser32.ReleaseDC(wnd: HWND; hdc: HDC): Int32; static; external 'ReleaseDC@user32.dll stdcall';
